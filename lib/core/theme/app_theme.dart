...
class AppTheme {
  ...
  static ThemeData light = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch(primarySwatch: AppColor.primarySwatch).copyWith(background: AppColor.backgroundWhite, brightness: Brightness.light),
    textTheme: TextTheme(
  ...
  static ThemeData dark = ThemeData(
    ...
    primaryColor: AppColor.primaryColor,
    colorScheme: ColorScheme.fromSwatch(primarySwatch: AppColor.primarySwatch).copyWith(background: AppColor.backgroundBlack, brightness: Brightness.dark),
    textTheme: TextTheme(
